"""Calculadora de Soma com Entrada do Usuário Leia 2 valores inteiros 
e armazene-os nas variáveis A e B.
...
a = int(input("Digite o primeiro valor interior: "))
b = int(input("Digite o segundo valor interior: "))
x = a + b
print(f"X = {x}")  
# Fim do codigo
